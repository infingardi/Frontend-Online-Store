Projeto em grupo desenvolvido na Trybe, utilizando a API do Mercado Livre para criar uma simulação de uma loja virtual, comvarias funcionalidades, desde filtros de pesquisa a carrinho de compra.
